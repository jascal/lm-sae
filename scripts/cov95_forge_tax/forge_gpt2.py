...
from forge_native import forge_native  # noqa: E402
...
def main(argv=None):
    ...
    p.add_argument("--output", type=Path, default=Path("runs/cov95_forge_tax/forge_gpt2_summary.json"))
    ...
    for n in ns:
        ...
        forged, host = forge_native(basis, "gpt2", "cpu", "auto")
