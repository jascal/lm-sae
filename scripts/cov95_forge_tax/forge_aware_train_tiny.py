...
def main():
    ...
    Path("runs/cov95_forge_tax/forge_aware_train_tiny_summary.json").write_text(json.dumps(out, indent=2, default=float))
    print("\n=== VERDICT ===")
    ...
    print("[done] runs/cov95_forge_tax/forge_aware_train_tiny_summary.json")
