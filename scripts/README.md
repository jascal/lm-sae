...
| `monosemantic_aux.py` | **aux-mode comparison** — none/linear/decorr/dedicated/sparsedict at fixed width; finds linear-recoverability is the *effective* lever (no direct objective beats it; the full in-loop aligned sparse dict is *worst*, hurting cov95 + capability). |
