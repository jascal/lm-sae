...
| `host_width_sweep.py` | **reachability test** — train tiny GPTs from scratch across host width, with/without an oracle-feature-recovery aux loss; supervision lifts native cov95 at ~zero capability cost (defeats the tower retrain no-go). |
