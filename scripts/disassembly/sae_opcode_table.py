...
def main(argv=None):
    ...
    p.add_argument("--token-summary", type=Path, default=Path("runs/disassembly/qk_opcode_table_summary.json"))
    p.add_argument("--output", type=Path, default=Path("runs/disassembly/sae_opcode_table_summary.json"))
