...
def main(argv=None):
    ...
    p.add_argument("--listing", type=Path, default=Path("runs/disassembly/gpt2_disassembly.txt"))
    p.add_argument("--output", type=Path, default=Path("runs/disassembly/gpt2_disassembly.json"))
