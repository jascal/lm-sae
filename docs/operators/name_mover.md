...
GPT-2-only circuit op (literature DLA head-set): 9.6, 9.9, 10.0, 10.10. No published head-set in the RoPE models — not in the cross-model atlas.
...
_Data: `runs/disassembly/operators/dossiers/name_mover/` + the atlas. Regenerate: `operator_catalog_doc.py`._